...
def main():
    ...
    print("RESULTS")
    print("=" * 60)
    print(f"Batched: seq0 matches seq1: {batched_seq0_matches_seq1} (max diff: {max_diff_batched:.6f})")
    print(f"Packed:  doc0 matches doc1: {packed_doc0_matches_doc1} (max diff: {max_diff_packed:.6f})")
    print(f"Batched vs Packed doc0:     {batched_matches_packed} (max diff: {max_diff_batched_vs_packed:.6f})")
