...
#SBATCH --job-name=RLVR-soofi-basev2-slr
...
JOB_NAME="RLVR-soofi-basev2-slr"
...
GRPO_ARGS="--exp_name $JOB_NAME \
  ...
  --kl_estimator 2 \
  --dataset_mixer_list allenai/Dolci-Think-RL-7B 1.0 AIML-TUDA/SLR-Bench:v1-Basic 1.0 AIML-TUDA/SLR-Bench:v1-Easy 1.0 AIML-TUDA/SLR-Bench:v1-Medium 1.0 \
